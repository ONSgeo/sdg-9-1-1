...
class UserParams:
    def __init__(self) -> None:
        ...
        self.raster_file_path: Optional[str] = f"{self.root_dir}\\data\\sdg_9_1_1_data\\2020_gridded_popn_raster.tif"
        
        # The specific path to the Rural Urban Classification file for the single year
        self.ruc_file_path: Optional[str] = f"{self.root_dir}\\data\\sdg_9_1_1_data\\Rural_Urban_Classification_2011_lookup_tables_for_local_authority_areas.xlsx"
        
        # The specific path to the LAD shape file for the single year
        self.lad_file_path: Optional[str] = f"{self.root_dir}\\data\\sdg_9_1_1_data\\LAD-2011\\Local_Authority_Districts_December_2011_GB_BFE.shp"
